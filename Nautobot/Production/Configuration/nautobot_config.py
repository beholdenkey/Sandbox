...
DATABASES = {
    "default": {
        ...
        "PASSWORD": os.getenv("NAUTOBOT_DB_PASSWORD", "P@ssw0rd12"),  # Database password
...
SECRET_KEY = os.getenv("NAUTOBOT_SECRET_KEY", "@1w%+gpi@51s%go@*c0em%yejwl=i*ohhjasoqlg)p$_7g^d4(")
...
BANNER_TOP = os.getenv("NAUTOBOT_BANNER_TOP", "JCU A&I Nautobot")
...
PLUGINS = ["nautobot_data_validation_engine", "nautobot_ssot", "nautobot_netbox_importer", "nautobot_plugin_nornir", "nautobot_golden_config"]
